...
// the kinds auspex maps are named; any other part type (file, step-start,
...
// Only the ids auspex promotes to a typed event are listed; every other id —
...
// OpenCode tool input argument keys, from the same tool sources. Auspex reads
...
// openCodePart is a tolerant view of one part .json. Only the fields auspex
...
// hash of the applied patch; auspex surfaces it as the edit's diff digest only
