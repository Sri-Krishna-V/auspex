...
// rollout for a SHELL call, and auspex never scrapes the prose body to invent
...
// response_item layer emits. auspex reads ONLY that structured Result — never the
...
// coverage for tools auspex does not specifically model (e.g. update_plan).
