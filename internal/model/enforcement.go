...
// Enforcement decisions are Auspex's portable effects on the host permission
...
// Enforcement reasons explain why Auspex selected its decision.
const (
...
// EnforcementDecision records Auspex's computed policy decision for a matched
